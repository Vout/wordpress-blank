...
function wpblank_add_script_tag_attributes($tag, $handle)
{
    switch ($handle) {
        ...
        case 'popper-js':
            return str_replace(
                ' min.js',
                'min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"',
                $tag
            );
            break;
        ...
        case 'bootstrap-js':
            return str_replace(
                ' min.js',
                'min.js" integrity="sha384-a5N7Y/aK3qNeh15eJKGWxsqtnX/wWdSZSKp+81YjTmS15nvnvxKHuzaWwXHDli+4" crossorigin="anonymous"',
                $tag
            );
            break;
...
if (!function_exists('wpblank_featured_image_behaviour')):
    function wpblank_featured_image_behaviour()
    {
        $meta = get_post_meta(
            get_the_ID(),
            'theme_options_featured-image-behaviour',
            true
        );
        echo $meta;
    }
